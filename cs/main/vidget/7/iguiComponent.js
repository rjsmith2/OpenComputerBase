...
iguiComponents.create.listWithDisplayPanel=function(document){
...
iguiComponents.create.directoryTreeWithDisplayPanel=function(document){
   var panelTableView= document.createElement("div");
   panelTableView.className="tlView";
   panelTableView.row=[];
   panelTableView.row.push(document.createElement("div"))
   ...
   panelTableView.directoryTreeView.reset=function(){
   }
